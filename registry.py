...
class ClientThread(threading.Thread):
    ...
    def __init__(self, ip, port, tcpClientSocket):
        ...
        self.isOnline = True
        self.udpServer = None
        print(Fore.GREEN +"New thread started for " + ip + ":" + str(self.port))

    # main of the thread
    def run(self):
        # locks for thread which will be used for thread synchronization
        self.lock = threading.Lock()
        print(Fore.MAGENTA +"Connection from: " + self.ip + ":" + str(port))
        ...
        while True:
            try:
                ...
                if not message:
                    print(Fore.LIGHTRED_EX+"No message received, client may have disconnected.")
                    break
...
print(Fore.MAGENTA +"Registy started...")
port = 15600
portUDP = 15500
...
#logging.basicConfig(filename="src/registry.log", level=logging.INFO)

# as long as at least a socket exists to listen registry runs
while inputs:

    print(Fore.YELLOW +"Listening for incoming connections...")
