                ...
                #   LOGOUT  #
                    ...
                    if (
                        ...
                        try:
                            ...
                            self.lock.release()
                        print(Fore.RED + self.ip + ":" + str(self.port) + " is logged out")
...
class UDPServer(threading.Thread):
    ...
    def waitHelloMessage(self):
        ...
        self.tcpClientSocket.close()
        print(Fore.GREEN + "Removed " + self.username + " from online peers")
...
print(Fore.CYAN + "Registy started...")
port = 15600
portUDP = 15500
...
print(Fore.CYAN + "Registry IP address: " + host)
print(Fore.CYAN + "Registry port number: " + str(port))
